...
import Gallery from "../ProjectGallery.vue";
export default {
  components: { Gallery },
  data() {
    return {
...
<template>
  ...
  <div class="overflow-hidden bg-white py-24 sm:py-32 animate-slide-in-left">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div
      ...
      >
        <div class="lg:pr-8 lg:pt-4">
          <div class="lg:max-w-lg">
            ...
            >
            Current Status of Software in Development
            </p>
            <p class="mt-6 text-lg leading-8 text-gray-600">
              {{ firstProject.future[0].details }}
            </p>
            <p class="mt-6 text-lg leading-8 text-gray-600">
              {{ firstProject.future[1].details }}
            </p>
            <p class="mt-6 text-lg leading-8 text-gray-600">
              {{ firstProject.future[2].details }}
            </p>
            <p class="mt-6 text-lg leading-8 text-gray-600">
              {{ firstProject.future[3].details }}
            </p>
          
          </div>
        </div>
        <img
          src="../../assets/Imagenes/InterfazMiniBizz.jpeg"
